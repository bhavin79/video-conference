...
import { callAcceptApiCall, callApiCall, ping } from "../../service/apiCalls";
...
const Call = ()=>{
    ...
    const handleSendOffer = useCallback(async()=>{
        try {
            console.log("peer connection in send offer",peerConnection);
                ...
                const data = {offer: offer, meetId: meetId}
    ...
    const handleOffer = useCallback(async(data)=>{
        ...
        socket.emit("answer", {answer: answer, meetId: meetId});
    ...
    const handleIceCandidate = useCallback((event)=>{
        if (event.candidate) {
            ...
            socket.emit("icecandiate", {candiates, meetId});
